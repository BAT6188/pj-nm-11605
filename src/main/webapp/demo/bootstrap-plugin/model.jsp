...
<br>
<br>
<div class="alert alert-info">模态框-js</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabe2">模态框（Modal）标题2</h4>
            </div>
...
<!-- 按钮触发模态框 -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal3">开始演示模态框3</button>
<!-- 模态框（Modal） -->
