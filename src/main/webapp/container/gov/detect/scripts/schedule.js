...
function saveAjax(entity, callback) {
    $.ajax({
        url: rootPath + "/action/S_detect_Schedule_save.action",
        type:"post",
        data:entity,
        dataType:"json",
        success:callback
...
function deleteAjax(ids, callback) {
    $.ajax({
        url: rootPath + "/action/S_detect_Schedule_delete.action",
        type:"post",
...
function initTable() {
    gridTable.bootstrapTable({
        ...
        url: rootPath+"/action/S_detect_Schedule_list.action",
...
$("#search").click(function () {
    ...
    var start_alertTime = $("#start_alertTime").val();
    var end_alertTime = $("#end_alertTime").val();
    if (title){
        queryParams["title"] = title;
    }
    if (start_alertTime){
        queryParams["start_alertTime"] = start_alertTime;
    }
    if (end_alertTime){
        queryParams["end_alertTime"] = end_alertTime;
    }
...
function resetForm() {
    ...
    disabledForm(false);
    form.find("#seter").attr("disabled",true);
    form.find("#save").show();
