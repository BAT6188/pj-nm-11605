        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">日程提醒名称<span class="text-danger">*</span>：</label>
                        <div class="col-sm-4">
                        ...
                        <label for="" class="col-sm-2 control-label">提醒时间<span class="text-danger">*</span>：</label>
                        <div class="col-sm-4">
                            <div id="" class="input-group date form_datetime" data-date="" data-date-format="yyyy-mm-dd hh:ii" data-link-field="sendTime">
                                <input class="form-control" size="16" id="alertTime" name="alertTime"  type="text" value="" readonly>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">设置提醒人员<span class="text-danger">*</span>：</label>
                        <div class="col-sm-3">
                            <input type="text" id="seter" name="seter" class="form-control"
                                   data-message="不能为空"
                                   data-easytip="position:top;class:easy-red;"
                            />
                            <input type="hidden" id="seterId" name="seterId"/>
                        </div>
                        <div class="col-sm-1">
                            <button type="button" class="btn btn-primary" id="select">选择</button>
                        </div>

                        <label for="" class="col-sm-2 control-label">职务<span class="text-danger">*</span>：</label>
                        <div class="col-sm-4">
...
<script src="<%=request.getContextPath()%>/container/gov/detect/scripts/schedule.js"></script>
</body>
</html>
