                ...
                <div class="queryBox marginLeft0">
                        <form class="form-inline">
                            <div class="form-group">
                                <label for="s_name">企业名称：</label> <input type="text" id="s_enterpriseName" style="width: 180px;" class="form-control" />
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="description" name="description" class="form-control" rows="4" cols="50" data-message="不能为空"
...
<script src="<%=request.getContextPath()%>/container/gov/exelaw/scripts/exelaw_selfCheckReport.js"></script>
</body>
</html>
