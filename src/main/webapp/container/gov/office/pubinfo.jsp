...
<div class="container-fluid">
    ...
    <!--列表区域-->
    <div id="toolbar">
        <button id="add" type="button" class="btn btn-primary" data-toggle="modal" data-target="#pubInfoForm" >新增</button>
        <button id="update" type="button" class="btn btn-info" data-toggle="modal" data-target="#pubInfoForm" >修改</button>
...
<!--添加表单-->
<div class="modal fade" id="pubInfoForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="pubInfoFormTitle" >创建信息公告</h4>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="savePubInfo">保存</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
<script src="scripts/pubinfo.js"></script>
</body>
</html>
