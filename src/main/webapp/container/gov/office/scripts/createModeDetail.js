var DemoPage = function () {
    ...
    function saveAjax(entity, callback) {
        $.ajax({
            url: rootPath + "/action/S_exelaw_LetterSue_save.action",
            type:"post",
            data:entity,
            dataType:"json",
            success:callback
    ...
    function deleteAjax(ids, callback) {
        $.ajax({
            url: rootPath + "/action/S_exelaw_LetterSue_delete.action",
            type:"post",
    ...
    function initTable() {
        gridTable.bootstrapTable({
            ...
            url: rootPath+"/action/S_exelaw_LetterSue_list.action",
...
//初始化表单验证
    var ef = form.easyform({
        success:function (ef) {
            ...
            entity.attachmentIds = getAttachmentIds(uploader);
            entity.attachmentIds = getAttachmentIds(uploader2);
            entity.attachmentIds = getAttachmentIds(uploader3);
            console.log(entity)
