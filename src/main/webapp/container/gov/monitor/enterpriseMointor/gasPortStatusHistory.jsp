...
<div class="content content1 clearfix">
    <div class="wrap">
        <div class="mainBox">
            <div id="headTitle" href="javascript:void(0)" class="list-group-item active" style="cursor: default;font-size: 15px;">废气排口-><span id="portName"></span> 实时数据
...
<script type="text/javascript" src="<%=request.getContextPath()%>/container/gov/monitor/enterpriseMointor/scripts/gasPortStatusHistory.js"></script>
</body>
</html>
