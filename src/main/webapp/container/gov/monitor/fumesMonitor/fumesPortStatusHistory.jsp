...
<div class="content content1 clearfix">
    <a id="headTitle" href="javascript:void(0)" class="list-group-item active" style="cursor: default;font-size: 15px;">油烟排口-><span id="portName"></span> 实时数据</a>
    <div class="wrap">
        <div class="mainBox">
            <div class="dealBox">
