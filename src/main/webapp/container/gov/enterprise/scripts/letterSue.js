var DemoPage = function () {
    ...
    function saveAjax(entity, callback) {
        $.ajax({
            url: rootPath + "/action/S_exelaw_LetterSue_save.action?enterpriseId="+enterpriseId,
            type:"post",
            data:entity,
            dataType:"json",
            success:callback
    ...
    function initTable() {
        gridTable.bootstrapTable({
            ...
            url: rootPath+"/action/S_exelaw_LetterSue_list.action?enterpriseId="+enterpriseId,
