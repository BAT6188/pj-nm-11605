...
function loadInfo(){
    $.ajax({
        ...
        type:"post",
        async:false,
        data:{"enterpriseId":enterpriseId,"type":"HWPWG"},//阻止深度序列化，向后台传递数组
        dataType:"json",
...
var thisUrl = rootPath +'/container/gov/enterprise/portThreshold/hrpWasteGasPT.jsp?id='+enterpriseId;
