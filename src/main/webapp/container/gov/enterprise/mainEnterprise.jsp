...
<div class="wrap">
    <div class="menu-left left">
        ...
        <div class="menuDiv">
            ...
            <ul>
                <li><a href="javascript:loadPageInEnterprise('/letterSue.jsp?id=<%=id%>');">信访投诉</a></li>
                <li><a href="javascript:loadPageInEnterprise('/check.jsp?id=<%=id%>');">现场检查（勘察）笔录</a></li>
                <li><a href="javascript:loadPageInEnterprise('/punish.jsp?id=<%=id%>');">行政处罚</a></li>
                <li><a href="javascript:loadPageInEnterprise('/problemCorrect.jsp?id=<%=id%>');">存在的问题及整改情况</a></li>
                <li><a href="javascript:loadPageInEnterprise('/pollutantPayment.jsp?id=<%=id%>');">排污收费</a></li>
            </ul>
        </div>
        <div class="menuDiv">
            <h3><a href="javascript:;">其他环境信息</a></h3>
            <ul>
                <li><a href="javascript:loadPageInEnterprise('/EnvTestProgram.jsp?id=<%=id%>')">环境自行监测方案</a></li>
                <li><a href="javascript:loadPageInEnterprise('/otherEnv.jsp?id=<%=id%>')">其他环境信息</a></li>
            </ul>
        </div>
        <div class="menuDiv">
