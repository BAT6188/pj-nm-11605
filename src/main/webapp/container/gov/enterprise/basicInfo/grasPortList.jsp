                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 isRadio" id="isNitrogen">
                            <label class="checkbox-inline"><input type="radio" name="isNitrogen" id="isNitrogen1" value="1">是</label>
                        ...
                        <div class="col-sm-4 isRadio" id="isSulfur">
                            <label class="checkbox-inline"><input type="radio" name="isSulfur" id="isSulfur1" value="1">是</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 isRadio" id="isGasFlow">
                            <label class="checkbox-inline"><input type="radio" name="isGasFlow" id="isGasFlow1" value="1">是</label>
                        ...
                        <div class="col-sm-4 isRadio" id="isOxygen">
                            <label class="checkbox-inline"><input type="radio" name="isOxygen" id="isOxygen1" value="1">是</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 isRadio" id="isDust">
                            <label class="checkbox-inline"><input type="radio" name="isDust" id="isDust1" value="1">是</label>
