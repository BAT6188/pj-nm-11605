...
function saveAjax(entity, callback) {
    $.ajax({
        url: rootPath + "/action/S_videodevice_VideoDevice_save.action",
        type:"post",
        data:entity,
        dataType:"json",
        success:callback
...
function deleteAjax(ids, callback) {
    $.ajax({
        url: rootPath + "/action/S_videodevice_VideoDevice_delete.action",
        type:"post",
...
function initTable() {
    gridTable.bootstrapTable({
        ...
        url: rootPath+"/action/S_videodevice_VideoDevice_list.action",
...
function disabledForm(disabled) {
    ...
    form.find(".tagging").attr("disabled",disabled);
