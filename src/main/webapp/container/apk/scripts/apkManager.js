...
function saveAjax(entity, callback) {
    $.ajax({
        url: rootPath + "/action/S_appclient_AppClient_save.action",
        type:"post",
        data:entity,
        dataType:"json",
        success:callback
...
function deleteAjax(ids, callback) {
    $.ajax({
        url: rootPath + "/action/S_appclient_AppClient_delete.action",
        type:"post",
...
function initTable() {
    gridTable.bootstrapTable({
        ...
        url: rootPath+"/action/S_appclient_AppClient_list.action",
