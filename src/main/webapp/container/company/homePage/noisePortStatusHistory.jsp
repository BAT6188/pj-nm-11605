...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            $.ajax({
                url: rootPath + "/action/S_port_NoisePort_getEntityById.action",
                type:"post",
                data:{id:portId},
                dataType:"json",
...
<script type="text/javascript" src="<%=request.getContextPath()%>/container/company/homePage/scripts/noisePortStatusHistory.js"></script>
</body>
</html>
