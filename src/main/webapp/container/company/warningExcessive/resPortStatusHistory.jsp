                ...
                <div class="queryBox marginLeft0">
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <div id="datetimepicker" class="input-group date form_datetime" data-date="" data-date-format="yyyy-mm" data-link-field="sendTime">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div id="datetimepicker2" class="input-group date col-md-10 form_datetime" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input" data-link-format="yyyy-mm-dd">
