        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="dustType" class="col-sm-2 control-label">除尘方式：</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label for="saltpetreType" class="col-sm-2 control-label">脱硝方式：</label>
                        <div class="col-sm-4">
...
<script src="<%=request.getContextPath()%>/container/company/proDeviceInfo/scripts/boilerList.js"></script>
<script>
    $(function(){
        initSelect();
