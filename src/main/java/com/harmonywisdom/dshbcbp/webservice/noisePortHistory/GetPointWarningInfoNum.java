...
public class GetPointWarningInfoNum  implements java.io.Serializable {
    private String strUserName;

    private String strUserPwd;

    public GetPointWarningInfoNum() {
    }
    ...
    /**
     * Gets the strUserName value for this GetPointWarningInfoNum.
     *
     * @return strUserName
     */
    ...
    /**
     * Sets the strUserName value for this GetPointWarningInfoNum.
     *
     * @param strUserName
     */
    ...
    /**
     * Gets the strUserPwd value for this GetPointWarningInfoNum.
     *
     * @return strUserPwd
     */
    ...
    /**
     * Sets the strUserPwd value for this GetPointWarningInfoNum.
     *
     * @param strUserPwd
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetPointWarningInfoNum)) return false;
        GetPointWarningInfoNum other = (GetPointWarningInfoNum) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetPointWarningInfoNum.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetPointWarningInfoNum"));
