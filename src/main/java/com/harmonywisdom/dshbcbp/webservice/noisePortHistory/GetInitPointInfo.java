...
public class GetInitPointInfo  implements java.io.Serializable {
    private String strUserName;

    private String strUserPwd;

    public GetInitPointInfo() {
    }
    ...
    /**
     * Gets the strUserName value for this GetInitPointInfo.
     *
     * @return strUserName
     */
    ...
    /**
     * Sets the strUserName value for this GetInitPointInfo.
     *
     * @param strUserName
     */
    ...
    /**
     * Gets the strUserPwd value for this GetInitPointInfo.
     *
     * @return strUserPwd
     */
    ...
    /**
     * Sets the strUserPwd value for this GetInitPointInfo.
     *
     * @param strUserPwd
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetInitPointInfo)) return false;
        GetInitPointInfo other = (GetInitPointInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetInitPointInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetInitPointInfo"));
