...
public class GetNoiseRealTime  implements java.io.Serializable {
    private String strUserName;

    private String strUserPwd;

    public GetNoiseRealTime() {
    }
    ...
    /**
     * Gets the strUserName value for this GetNoiseRealTime.
     *
     * @return strUserName
     */
    ...
    /**
     * Sets the strUserName value for this GetNoiseRealTime.
     *
     * @param strUserName
     */
    ...
    /**
     * Gets the strUserPwd value for this GetNoiseRealTime.
     *
     * @return strUserPwd
     */
    ...
    /**
     * Sets the strUserPwd value for this GetNoiseRealTime.
     *
     * @param strUserPwd
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetNoiseRealTime)) return false;
        GetNoiseRealTime other = (GetNoiseRealTime) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetNoiseRealTime.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetNoiseRealTime"));
