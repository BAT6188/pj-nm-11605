...
public class GetAllPointStata  implements java.io.Serializable {
    private String strUserName;

    private String strUserPwd;

    public GetAllPointStata() {
    }
    ...
    /**
     * Gets the strUserName value for this GetAllPointStata.
     *
     * @return strUserName
     */
    ...
    /**
     * Sets the strUserName value for this GetAllPointStata.
     *
     * @param strUserName
     */
    ...
    /**
     * Gets the strUserPwd value for this GetAllPointStata.
     *
     * @return strUserPwd
     */
    ...
    /**
     * Sets the strUserPwd value for this GetAllPointStata.
     *
     * @param strUserPwd
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetAllPointStata)) return false;
        GetAllPointStata other = (GetAllPointStata) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAllPointStata.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetAllPointStata"));
