...
public class GetTrafficRealTime  implements java.io.Serializable {
    private String strUserName;

    private String strUserPwd;

    public GetTrafficRealTime() {
    }
    ...
    /**
     * Gets the strUserName value for this GetTrafficRealTime.
     *
     * @return strUserName
     */
    ...
    /**
     * Sets the strUserName value for this GetTrafficRealTime.
     *
     * @param strUserName
     */
    ...
    /**
     * Gets the strUserPwd value for this GetTrafficRealTime.
     *
     * @return strUserPwd
     */
    ...
    /**
     * Sets the strUserPwd value for this GetTrafficRealTime.
     *
     * @param strUserPwd
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetTrafficRealTime)) return false;
        GetTrafficRealTime other = (GetTrafficRealTime) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetTrafficRealTime.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetTrafficRealTime"));
