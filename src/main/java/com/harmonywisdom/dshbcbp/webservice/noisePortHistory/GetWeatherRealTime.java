...
public class GetWeatherRealTime  implements java.io.Serializable {
    private String strUserName;

    private String strUserPwd;

    public GetWeatherRealTime() {
    }
    ...
    /**
     * Gets the strUserName value for this GetWeatherRealTime.
     *
     * @return strUserName
     */
    ...
    /**
     * Sets the strUserName value for this GetWeatherRealTime.
     *
     * @param strUserName
     */
    ...
    /**
     * Gets the strUserPwd value for this GetWeatherRealTime.
     *
     * @return strUserPwd
     */
    ...
    /**
     * Sets the strUserPwd value for this GetWeatherRealTime.
     *
     * @param strUserPwd
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetWeatherRealTime)) return false;
        GetWeatherRealTime other = (GetWeatherRealTime) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetWeatherRealTime.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetWeatherRealTime"));
