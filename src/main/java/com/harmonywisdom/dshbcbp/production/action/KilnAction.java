...
public class KilnAction extends BaseAction<Kiln, KilnService> {
    ...
    public void save() {
        ...
        if(StringUtils.isNotBlank(entityId)){
            CommonUtil.insertBaseOpLog(iPerson.getPersonId(), Constants.OPTYPE_UPDATE,"企业台账","窑炉信息",entity.getId());
        }else{
            CommonUtil.insertBaseOpLog(iPerson.getPersonId(), Constants.OPTYPE_ADD,"企业台账","窑炉信息",entity.getId());
        }
    ...
    public void delete() {
        ...
        super.delete();
        IPerson iPerson = ApportalUtil.getPerson(request);
        CommonUtil.insertAllOpLog(iPerson.getPersonId(), Constants.OPTYPE_DELETE,"企业台账","窑炉信息","FumesPort",deleteId,null);
    }
}