...
public class EnvTestProgramAction extends BaseAction<EnvTestProgram, EnvTestProgramService> {
    ...
    protected QueryCondition getQueryCondition() {
        ...
        if(StringUtils.isNotBlank(entity.getAttachmentName())){
            params.andParam(new QueryParam("attachmentName", QueryOperator.LIKE,"%"+entity.getAttachmentName()+"%"));
        }
        if(entity.getYear()!=null){
            params.andParam(new QueryParam("year", QueryOperator.EQ,entity.getYear()));
        }
